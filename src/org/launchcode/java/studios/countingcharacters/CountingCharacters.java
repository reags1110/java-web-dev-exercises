...
public class CountingCharacters {
    public static void main(String[] args) {
        ...
        String myString = "If the product of two terms is zero then common sense says at least one of the two terms " +
                ...
                "So if you move all the terms over to one side, you can put the quadratics into a form that can be " +
        ...
        //convert myString to array of characters
        char[] charactersInString = myString.toLowerCase().toCharArray();
        System.out.println(charactersInString);

        //find out which characters are in the string, and then count their iteration once you've found one example of it
